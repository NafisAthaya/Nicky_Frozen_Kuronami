...
import nuggetImg from '../../assets/product/Kategori 4_Olahan/CHICKEN NUGGET PREMIUM.png';
import baksoImg from '../../assets/product/Kategori 4_Olahan/BAKSO SAPI & AYAM SIAP REBUS.png';
import sosisImg from '../../assets/product/Kategori 4_Olahan/Sosis Sapi Bratwurst.png';
  ...
  return (
    <div className="animate-fadeIn w-full h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {stats.map((stat) => (
          <div key={stat.id} className="bg-white rounded-[18px] border border-[#D9DCE7] p-6 flex items-start justify-between shadow-smhover:shadow-md transition-shadow">
            <div>
              <p className="text-xs font-bold text-slate-400 tracking-wider mb-2">{stat.title}</p>
              <h2 className="text-[32px] font-bold text-[#08224A]">{stat.value}</h2>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6">
        ...
        {/* Top Products */}
        <div className="bg-[#0B46B3] rounded-2xl p-6 text-white shadow-lg h-fit">
          <div>
            <div className="flex items-center justify-between mb-6">
          ...
          <button 
            ...
            className="mt-8 w-full bg-[#FFB800] hover:bg-[#FFC633] text-black text-sm font-bold py-4 px-4 rounded-xl transition-all shadow-md flex items-center justify-center gap-2"
          >
            Lihat Semua Laporan
